...
<body>
	<div class="container">
		...
		<form action="javascript:void(0);" id="shopProducts">
				...
				<div class="col-md-4" v-for="product in products">
					<div class="card">
						...
						<div class="card-body">
							...
							Cantidad: <input type="number" value="1" min="1" v-model="product.qty">
			...
			<button class="btn-block mt-3 mb-3" v-on:click="endShopping()" v-if="shoppingCart > 0"> Finalizar Compra </button>
		</form>
	</div>
